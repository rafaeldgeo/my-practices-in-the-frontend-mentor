...
try {
  ...
  assertEqual('heatmap panel title hidden', consistency.innerHTML.includes('dashboard__sr-only">Consistency'), true)
  ...
  assertEqual('heatmap continuous rows rendered', consistency.innerHTML.includes('dashboard__heatmap-row'), true)
  assertEqual('heatmap 7 rows rendered', (consistency.innerHTML.match(/dashboard__heatmap-row"/g) || []).length, 7)
  assertEqual('heatmap week semantics preserved', consistency.innerHTML.includes('consistency-week-summary'), true)
  assertEqual('heatmap 196 cells rendered', (consistency.innerHTML.match(/role="gridcell"/g) || []).length, 196)
  assertEqual('heatmap placeholder cells removed', (consistency.innerHTML.match(/data-is-placeholder="true"/g) || []).length, 0)
  ...
  assertEqual('heatmap continuous empty weeks rendered', consistency.innerHTML.includes('data-date="2025-10-09"'), true)
  ...
  assertEqual('heatmap grid exposes continuous column index', consistency.innerHTML.includes('aria-colindex="28"'), true)
  assertEqual('heatmap grid exposes row index', consistency.innerHTML.includes('aria-rowindex="1"'), true)
  assertEqual('heatmap focusable cells kept', (consistency.innerHTML.match(/tabindex="0"/g) || []).length, 196)
